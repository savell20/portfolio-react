...
const STUDIES = {
  ...
  loomi: {
    ...
    intro: 'A reading buddy app for kids, gamified reading practice with adaptive difficulty, designed and prototyped end-to-end as a SCAD studio project.',
    stats: [
      ['12wk', 'Solo build'],
      ['8', 'User tests'],
      ['1', 'Designer'],
    ...
    overview: [
      'Loomi tackles the moment a kid loses interest in reading, when the book is just slightly too hard. I designed an app that detects struggle in real time and adapts the difficulty without breaking flow.',
      'Built as a solo end-to-end studio project at SCAD: research, IA, visual design, prototype, and usability testing with eight kids and their parents.',
    ],
    highlights: [
      'Designed a streak-aware reading loop with adaptive vocabulary swaps.',
      'Prototyped in Figma + ProtoPie; ran 8 moderated tests with kids aged 6–9.',
      'Synthesized findings into a v2 spec the program faculty highlighted.',
    ],
    takeaway: 'Designing for kids made me ruthless about clarity. If a 7-year-old can’t figure out what to do in 3 seconds, the UI lost.',
  },
  greenstep: {
    name: 'GreenStep',
    frame: 'greenstep.case',
    role: 'SCAD Service Design',
    dates: 'Jan-Apr 2024',
    tags: ['Student', 'Climate', 'Research'],
    cover: 'linear-gradient(135deg,#1F8A6E,#7CCFB4)',
    intro: 'A carbon-footprint tracker that turns everyday choices into small, doable steps, researched, designed, and tested with twelve students as part of a SCAD service design studio.',
    stats: [
    ...
    overview: [
      'Most climate apps overwhelm. GreenStep pares it down to one daily choice, and uses behaviour science to make that choice stick.',
      'Researched current climate-tracker apps, ran a diary study with 12 SCAD students, mapped the journey, designed and prototyped a v1, and tested with the same cohort.',
    ],
    highlights: [
      'Mapped the carbon decision journey across three daily moments.',
      'Designed a streak + community loop without resorting to guilt.',
      'Tested with 12 students and iterated based on weekly diary notes.',
    ],
    takeaway: 'I learned that good service design isn’t about more features, it’s about removing every step that lets the user opt out.',
  },
}
